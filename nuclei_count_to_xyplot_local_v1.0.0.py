...
label = tk.Label(root, text="Enter nine doses (M), separated by tab:")
label.pack()
entry = tk.Entry(root)
entry.pack()

# Create plot labels and their entry fields
label1 = tk.Label(root, text = "Enter the title of the graph (include drug used):")
label1.pack()
entry1 = tk.Entry(root)
entry1.pack()
label2 = tk.Label(root, text = "Enter the name of the cell condition in rows B-D:")
label2.pack()
entry2 = tk.Entry(root)
entry2.pack()
label3 = tk.Label(root, text = "Enter the name of the cell condition in rows E-G:")
label3.pack()
entry3 = tk.Entry(root)
entry3.pack()

# Create buttons for selecting directories and files
image_dir_button = tk.Button(root, text="Select Image Directory", command=select_image_dir)
...
IC50_ratio = IC50_y1.x[0] / IC50_y2.x[0]
